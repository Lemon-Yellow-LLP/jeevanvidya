...
export function SliderPrevButton() {
  ...
  return (
    <button
      ...
      className='w-[48px] h-[48px] rounded-full border-[2px] bg-white border-[rgba(18,_33,_53,_0.24)] hover:border-transparent text-foreground-1 hover:text-secondary-1 hover:shadow-secondary flex justify-center items-center disabled:pointer-events-none'
    >
      <svg
        width='32'
        height='32'
