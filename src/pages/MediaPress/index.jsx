...
export default function MediaPress() {
  ...
  return (
    <section className='pt-[164px]'>
      ...
      <div className='pt-4'>
        <div class='w-[410px] flex flex-col items-start transform transition duration-500 hover:scale-105 hover:bg-white hover:shadow-lg rounded-xl'>
          <img src={mediaVideo} class='w-full' alt='' />
          <div class='p-4 flex flex-col items-start gap-2'>
            <h3 class='text-[22px] font-semibold text-[#122135]'>Title</h3>
